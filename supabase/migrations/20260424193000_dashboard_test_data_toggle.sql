...
begin
  ...
  if v_include_test_data then
    return public.dashboard_product_summary(p_game_slug, p_region, p_pro_status, p_feedback_type);
  end if;
...
begin
  ...
  if v_include_test_data then
    return public.dashboard_product_growth(p_days, p_game_slug, p_region, p_pro_status);
  end if;
...
begin
  ...
  if v_include_test_data then
    return public.dashboard_product_operations(p_days, p_game_slug, p_region);
  end if;
...
begin
  ...
  if v_include_test_data then
    return public.dashboard_product_feedback(p_days, p_feedback_type, p_platform, p_app_version);
  end if;
...
begin
  ...
  if v_include_test_data then
    return public.dashboard_product_advanced_metrics(
      p_days,
      p_platform,
      p_app_version,
      p_event_name,
...
begin
  ...
  if v_include_test_data then
    return public.dashboard_product_funnel(p_days, p_platform, p_app_version);
  end if;
...
begin
  ...
  if v_include_test_data then
    return public.dashboard_product_retention(p_platform, p_app_version);
  end if;
...
begin
  ...
  if v_include_test_data then
    return public.dashboard_product_alerts(p_days, p_platform, p_app_version, p_region, p_game_type);
  end if;
